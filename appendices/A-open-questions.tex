...
(Section~\ref{sec:remnant}). The same accounting therefore decides three things at
once: the $41\times$ shortfall, whether the surviving remnant is over- or
under-supplied, and whether lineages stay chirally pure or mix
(Chapter~\ref{chap:supraverse}). It is entangled with Q5 (baryon-number
conservation) and Q8 (bounce efficiency / entropy budget), and is the cleanest
near-term lever on the asymmetry problem.
