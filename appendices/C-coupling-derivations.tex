...
\begin{figure}[t]
  ...
  \caption{The torsiton as a self-consistent chiral soliton. \emph{Left:} the chiral angle
    ...
    \emph{Right:} the converged central angle $\theta(0)$ versus the cutoff $\Lambda$ (the L5 scale),
    ...
    constituent sum. Reproduced by \texttt{figures/scripts/appC\_torsiton\_profile.py}.}
