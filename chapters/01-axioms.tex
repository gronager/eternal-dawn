...
whole has no external clock (Chapter~\ref{chap:timearrow}); time is emergent,
...
contain condensed universes (Chapter~\ref{chap:supraverse},
...
loop: rare fluctuations reach Cartasis density, bounce instead of collapsing, extrude
baby universes, grow, heat-die into smooth voids, and seed the next generation---
forever, with no first cause and no fine-tuning (\Cref{chap:supraverse}). We do not
...
among uncountably many (\Cref{chap:supraverse}). And the framework's central claim is
